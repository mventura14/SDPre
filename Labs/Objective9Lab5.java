    ...
    public static void main(String[] args) {
        ...
        while (keepGoing) {
            ...
            switch (choice) {
                ...
                case 1:
                    System.out.printf("%f + %f = %f %n",num1,num2,findSum(num1,num2));
                break;
                case 2:
                     System.out.printf("The average of %f and %f is: %f %n", num1,num2,findAverage(num1,num2));
                    break;
                case 3:
                     System.out.printf("The average of %f and %f is: %f", num1,num2,calcTax(num1,num2));
                    break;
                case 4:
